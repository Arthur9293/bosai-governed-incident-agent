...
- Strands `AgentResult` stop reasons;
- accumulated token usage;
- actual Strands tool metrics/call counts;
- model messages for the synthetic scenario;
...
`HUMAN_GO_REQUIRED`, no forbidden mutating tool is observed, and the runtime remains unchanged.
...
- 13 unit/governance tests pass locally and in CI;
